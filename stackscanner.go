...
type Signal struct {
	Source string `json:"source"`           // html, header, header_key, script_src, dns_cname, dns_rdns, ip, favicon_sha1, favicon_mmh3
